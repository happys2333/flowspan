...
- [x] 1. Freeze Scene-repository requirements and design
...
- [x] 2. Implement the persistent Scene repository
...
- [x] 3. Implement the protected platform stores
...
- [x] 4. Implement the redacted Scene export
...
- [x] 5. Implement the Desktop repository lifecycle
...
- [x] 6. Close Scene-repository automated evidence
